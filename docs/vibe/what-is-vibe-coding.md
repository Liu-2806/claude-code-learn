...
2025 年初，Andrej Karpathy（前特斯拉 AI总监、OpenAI 联合创始人）提出了这个概念：

> "我基本上只是跟 AI 谈话，描述我想要什么，然后它就写出来了。我几乎不看代码细节——我更像是用'感觉'来引导方向。"

Karpathy 同时强调：Vibe Coding **不是放弃理解**。它最有效的时候，恰恰是你已经有了扎实基础的时候。他把它比作"骑一辆带电机的自行车——你仍然需要转向，只是不用那么费力蹬了"。
