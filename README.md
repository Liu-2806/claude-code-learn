...
**Anthropic 官方 CLI 工具的完整中文使用指南 — 从入门到精通**
...
| 🌳 | **Git Worktree 并行开发** | 多个 Claude 实例同时在不同分支上工作 |
| 📋 | **spec→plan→tasks 工作流** | 文档驱动，减少幻觉，跨会话延续 |
| 🔗 | **MCP 服务器集成** | 连接外部工具和数据源 |
...
- **案例** — 从零搭建项目、调试遗留代码、代码审查重构、CI/CD 自动化、spec→plan→tasks 实战...
- **FAQ** — 13 个常见问题及解决方案
