...
<img src="docs/public/banner.png" alt="banner" width="100%">
...
工具谁都能装，命令谁都能敲。真正拉开差距的，是你怎么描述意图、怎么跟 AI 协作、怎么迭代验证。

<img src="docs/public/badges.png" alt="badges" width="100%">

- **意图优于语法** — 不用纠结代码怎么写，先想清楚你要什么
- **迭代验证，而非一次生成** — AI 是伙伴不是魔法，闭环迭代才是正确姿势
- **人做守门员，AI 做执行者** — 你掌舵，Claude 划船，放手但不放任
...
| 💔 | **7 大反模式避坑** | 别再"一句话甩任务"，那些你以为的高效用法可能全是坑 |
| 📋 | **四大 SOP** | 项目搭建、调试排障、重构迁移、审查发布，按流程走 |
